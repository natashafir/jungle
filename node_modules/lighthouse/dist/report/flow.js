...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function ja(){const e=window.location.host.endsWith(".vercel.app"),a=new URLSearchParams(window.location.search).has("dev");return e?`https://${window.location.host}/gh-pages`:a?"http://localhost:7333":"https://googlechrome.github.io/lighthouse"}function Ma(e){const a=e.generatedTime,n=e.fetchTime||a;return`${e.lighthouseVersion}-${e.finalDisplayedUrl}-${n}`}async function Fa(e,a,n){const t=new URL(a),i=Boolean(window.CompressionStream);t.hash=await Ea.toBase64(JSON.stringify(e),{gzip:i}),i&&t.searchParams.set("gzip","1"),window.open(t.toString(),n)}async function Ba(e){const a="viewer-"+Ma(e);!function(e,a,n){const t=new URL(a).origin;window.addEventListener("message",(function a(n){n.origin===t&&i&&n.data.opened&&(i.postMessage(e,t),window.removeEventListener("message",a))}));const i=window.open(a,n)}({lhr:e},ja()+"/viewer/",a)}
/**
   * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
   * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
...
/**
   ...
   * limitations under the License.
   */
function(e){return Array.from(e.tBodies[0].rows)}(e).filter((e=>!e.classList.contains("lh-sub-item-row"))),t=this._getThirdPartyRows(n,le.getFinalDisplayedUrl(this.json)),i=this._dom.createComponent("3pFilter"),o=this._dom.find("input",i);o.addEventListener("change",(e=>{const a=e.target instanceof HTMLInputElement&&!e.target.checked;let i=!0,o=n[0];for(;o;){const e=a&&t.includes(o);do{o.classList.toggle("lh-row--hidden",e),o.classList.toggle("lh-row--even",!e&&i),o.classList.toggle("lh-row--odd",!e&&!i),o=o.nextElementSibling}while(o&&o.classList.contains("lh-sub-item-row"));e||(i=!i)}})),this._dom.find(".lh-3p-filter-count",i).textContent=`${t.length}`,this._dom.find(".lh-3p-ui-string",i).textContent=ue.strings.thirdPartyResourcesLabel;const r=t.length===n.length,s=!t.length;if((r||s)&&(this._dom.find("div.lh-3p-filter",i).hidden=!0),!e.parentNode)return;e.parentNode.insertBefore(i,e);const l=e.closest(".lh-audit");if(!l)throw new Error(".lh-table not within audit");a.includes(l.id)&&!r&&o.click()}))}_setupElementScreenshotOverlay(e){this._fullPageScreenshot&&Ua.installOverlayFeature({dom:this._dom,rootEl:e,overlayContainerEl:e,fullPageScreenshot:this._fullPageScreenshot})}_getThirdPartyRows(e,a){const n=le.getRootDomain(a),t=this.json.entities?.find((e=>!0===e.isFirstParty))?.name,i=[];for(const a of e){if(t){if(!a.dataset.entity||a.dataset.entity===t)continue}else{const e=a.querySelector("div.lh-text__url");if(!e)continue;const t=e.dataset.url;if(!t)continue;if(!(le.getRootDomain(t)!==n))continue}i.push(a)}return i}_saveFile(e){const a=e.type.match("json")?".json":".html",n=(t={finalDisplayedUrl:le.getFinalDisplayedUrl(this.json),fetchTime:this.json.fetchTime},Wa(new URL(t.finalDisplayedUrl).hostname,t.fetchTime)+a);var t;this._opts.onSaveFileOverride?this._opts.onSaveFileOverride(e,n):this._dom.saveFile(e,n)}}
/**
   * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
   * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
...
/**
   ...
   * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
   */
function kn(n,t,i){t.classList.add("flow-vars","lh-vars","lh-root"),function(n,t,i){var o,r,l;a.__&&a.__(n,t),r=(o="function"==typeof i)?null:i&&i.__k||t.__k,l=[],U(t,n=(!o&&i||t).__k=d(h,null,[n]),r||s,s,void 0!==t.ownerSVGElement,!o&&i?[i]:r?null:t.firstChild?e.call(t.childNodes):null,l,!o&&i?i:r?r.__e:t.firstChild,o),x(l,n)}(d(Cn,{flowResult:n,options:i}),t)}
/**
   * @license Copyright 2021 The Lighthouse Authors. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
   * Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
   */window.__initLighthouseFlowReport__=function(){const e=document.body.querySelector("main");if(!e)throw Error("Container element not found");kn(window.__LIGHTHOUSE_FLOW_JSON__,e,{getReportHtml:()=>document.documentElement.outerHTML})},window.__initLighthouseFlowReport__()}();
